...
const SessionTimeout = () => {
  ...
  const buttonClassNames =
    "px-4 pb-2 pt-1 bg-[#eb1933] rounded-[3px] lg:text-xl text-2xl font-bold text-white cursor-default z-[0]";
  useEffect(() => {
    let timeoutId;
  ...
  return (
    <div className="flex gap-5 flex-col justify-center items-center pt-6 pb-10 border-b px-6">
